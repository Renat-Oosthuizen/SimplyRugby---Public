...
public class LoginScreen extends JFrame {
	...
	public LoginScreen(LoginController control) {
		...
		lblLogo.setIcon(new ImageIcon(LoginScreen.class.getResource("/images/Medium Transparent Logo.png"))); //Give the JLabel an image to display.
		...
		//Error Label
		JLabel lblErrorMessage = new JLabel(""); //Create a new JLabel with no text.
